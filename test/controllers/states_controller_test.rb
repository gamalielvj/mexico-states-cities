...
class StatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create state" do
    assert_difference('State.count') do
      post states_url, params: { state: { countries_id: @state.countries_id, name: @state.name, state_code: @state.state_code } }
    end
  ...
  test "should update state" do
    patch state_url(@state), params: { state: { countries_id: @state.countries_id, name: @state.name, state_code: @state.state_code } }
